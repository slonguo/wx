...
// source:
// https://github.com/shramov/json2pb/blob/master/bin2ascii.h
// (slonguo) made minor adjustments on type conversions to resolve compiler warnings
// similar snippets: https://stackoverflow.com/questions/3381614/c-convert-string-to-hexadecimal-and-vice-versa
...
inline std::string hex2bin(const std::string &s)
{
	...
	for (size_t i = 0; i < s.size(); i += 2) {
		// add by slonguo: add type conversion to resolve compiler complaint
